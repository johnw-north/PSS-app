    ...
    <>
      <section className="py-4">
        ...
        <div className="gap-2 py-4 px-2 grid grid-cols-2 sm:grid-cols-3 sm:px-4 sm:gap-4 md:grid-cols-4">
          <Product
            image="src/assets/Products/IMG-20260228-WA0002.jpg"
            title="Fantasy Books"
            price={10}
          />
          <Product
            image="src/assets/Products/IMG-20260228-WA0004.jpg"
            title="Cat in a Box"
            price={12}
          />
          <Product
            image="src/assets/Products/IMG-20260228-WA0007.jpg"
            title="Daisy"
            price={10}
          />
          <Product
            image="src/assets/Products/IMG-20260228-WA0008.jpg"
      ...
      <section className="py-4">
        ...
        <div className="gap-2 py-4 px-2 grid grid-cols-2 sm:grid-cols-3 sm:px-4 sm:gap-4 md:grid-cols-4">
          <Product
            image="src/assets/Products/IMG-20260228-WA0010.jpg"
            title="Choco Bar"
            price={12}
          />
          <Product
            image="src/assets/Products/IMG-20260228-WA0011.jpg"
            title="Ice Cream Cone"
            price={8}
          />
          <Product
            image="src/assets/Products/IMG-20260228-WA0012.jpg"
            title="Pizza Slice"
            price={6}
          />
          <Product
